'''
Animation des personnages: le lapin doit sauter !
'''
import pygame
import random
from os import path
...
class Player(pygame.sprite.Sprite):
    def __init__(self, platforms):
        ...
        # /part10/1 - ajout de l'état pour marcher
        self.walking = False
        self.jumping = False
    ...
    # /part10/2 - chargement des images du Player
    def load_images(self):
        ...
        for frame in chain(self.standing_frames, self.walk_frames_r, 
                           self.walk_frames_l, [self.jump_frame]):
            frame.set_colorkey(BLACK)
          
    def update(self):
        # /part10/3 - ajout de l'animation des images
        self.animate()
    ...
    def animate(self):
        ...
        if not self.jumping and not self.walking:
            if now - self.last_update > 400:
                ...
                # /part10/6 - le bas de l'animation est mal positionné
