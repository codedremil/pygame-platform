'''
Ajout de la musique et des sons
Challenge: ajouter la musique sur le go-screen !
Provenance: opengameart
'''
import pygame
import random
from os import path
...
# part1/8: musique du start screen
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    player.jump()
                    #jump_sound.play()   # part14/3: naïf car trop de sons
