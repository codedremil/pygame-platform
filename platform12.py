'''
Ajout des graphiques pour les plateformes et correction de bugs
'''
import pygame
import random
from os import path
...
PLATFORM_LIST = [
    # part12/3: on veut que la 1ère plateforme soit "décollée" du bas
...
class Player(pygame.sprite.Sprite):
    def __init__(self, platforms):
        ...
        # part12/4: on veut que le joueur soit positionné sur la 1ère pf
    ...
    def jump(self):
        ...
        # part12/5: si on trouve que le saut ne marche pas bien
        # on change les valeurs 1 en 2
        self.rect.y += 1
...
class Platform(pygame.sprite.Sprite):
    # part12/2: width et height ne servent plus à rien
    def __init__(self, x, y, width, height):
        super().__init__()
        
        # part12/1: charge les images des plateformes
        images = [
...
while want_to_play:    
    ...
    while running:
        ...
        # part12/6: parfois le joueur passe "derrière" les PF: on le
