'''
Ajout d'un arrière-plan défilant
'''
import pygame
import random
from os import path
...
class Cloud(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        # part18/7: taille aléatoire pour les nuages
    ...
    # part18/6
    def update(self):
        # part18/9: change le test pour afficher les nuages quand le joueur tombe
...
def load_images():
    ...
    # part18/4: chargement des nuages
    for i in range(1, 4):
        cloud_images.append(pygame.image.load(
...
while want_to_play:    
    ...
    all_clouds = pygame.sprite.Group()  # part18/3
    score = 0
    mob_timer = 0
    ...
    while running:
        ...
        if player.rect.top <= HEIGHT / 4:
            # part18/7: génère un nouveau nuage aléatoirement
            ...
            # part18/8: on déplace les nuages vers le bas mais moins rapidement
            for cloud in all_clouds:
                # part18/10: challenge, ajout vitesse aléatoire
