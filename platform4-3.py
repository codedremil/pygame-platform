...
donc on n'implémente la gestion de la touche de saut dans la boucle
principale.
On corrige le saut en testant qu'on est bien sur une plate-forme !
...
class Player(pygame.sprite.Sprite):
    # /part4/3 - le joueur doit connaitre les plateformes
    def __init__(self, platforms):
        super().__init__()
        self.platforms = platforms        # /part4/3
    ...
    def jump(self):
        ...
        # 2ème version: on teste qu'on est sur une plateforme !
        # mais le joueur ne connait pas les plateformes, donc on
        # modifie __init__
        self.rect.y += 1
...
# /part4/4 - déplacement des lignes et ajout parm
