'''
On utilise les spritesheets.
On créé un sous-répertoire ./img avec les sprites et leur description.
On donne une image au joueur
'''
import pygame
import random
from os import path
...
# /part9/1 - pour charger et gérer la spritesheet
class Spritesheet:
    ...
    def get_image(self, x, y, width, height):
        ...
        # /part9/6 - resizeing (après test du Player)
...
class Player(pygame.sprite.Sprite):
    def __init__(self, platforms):
        ...
        # /part9/4 - donne l'image du joueur
        #self.image = pygame.Surface((30, 40))
        #self.image.fill(YELLOW)
        self.image = spritesheet.get_image(614, 1063, 120, 191)
        # on teste et on voit 2 pb : la taille et le background
        # le resize est fait dans get_image
        # /part9/5 - background
