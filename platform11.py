'''
Animation des personnages: le lapin doit sauter et marcher
'''
import pygame
import random
from os import path
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # /part11/2 - définit un seuil minimal
        ...
        # /part11/3 - amélioration de la gestion des bords
    ...
    def animate(self):
        ...
        # /part11/1 - détermine si on marche
        if self.vel.x != 0:
            self.walking = True
        else:
            self.walking = False
